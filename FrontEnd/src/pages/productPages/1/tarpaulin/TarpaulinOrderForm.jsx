  ...
  return (
    <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
      <div className="xl:col-span-2 flex flex-col gap-6">
            ...
            {area > 0 && (
              <div className="flex items-center gap-3 bg-blue-50 border border-blue-100 rounded-xl px-4 py-3">
                ...
                <div className="text-sm text-blue-700">
                  <strong>Area: {area.toFixed(2)} sq ft</strong>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <Field label="Thickness">
              <select value={thickness} onChange={(e) => setThickness(e.target.value)} className={selectCls}>
                {["10oz", "13oz", "15oz", "18oz"].map((t) => (
                  <option key={t}>{t}</option>
                ))}
              </select>
              <div className="mt-3 bg-gray-50 border border-gray-100 rounded-xl p-3">
                <p className="text-xs text-gray-500 leading-relaxed">
                  <strong>10oz</strong> — lightweight, indoor use
                  <br />
                  <strong>13oz</strong> — standard outdoor
                  <br />
          ...
          <div className="flex flex-col gap-5">
              ...
              >
                <span
                  className={`text-3xl transition-transform ${
                    file ? "text-green-500" : "text-gray-400 group-hover:text-red-400 group-hover:scale-110"
                  }`}
                >
            ...
            <label className="flex items-start gap-3 cursor-pointer group">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400 mt-0.5">
                  Our team will contact you to discuss your layout and artwork.
                </p>
              </div>
            </label>
            ...
            <Field label="Special Instructions" hint="Font preferences, color codes, layout notes, etc.">
              <textarea
                ...
                rows={3}
                placeholder="e.g. Use red and white color scheme, add our logo at the top left..."
        ...
        <SectionCard title="Layout & Accessories" icon={<FiTool />}>
        ...
        <div className="sticky top-36 flex flex-col gap-4">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div className="p-5 flex flex-col gap-2 text-xs text-gray-600">
              ...
              <div className="flex justify-between">
                <span>Area</span>
                <span className="font-semibold">{area > 0 ? `${area.toFixed(2)} sq ft` : "—"}</span>
              </div>
              <div className="flex justify-between">
                <span>Quantity</span>
